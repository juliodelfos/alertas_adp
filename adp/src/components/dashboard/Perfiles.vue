      ...
      >
        <b-row no-gutters>
          ...
          <b-container class="px-5 pt-4">
            <h3 class="fs-6 text-start">Porcentaje avance año de gestión</h3>
            <b-progress
          ...
          <b-col md="12" class="py-3">
            <b-card-body>
              ...
              />
              <img
                src="https://images.unsplash.com/photo-1599765625577-61a6e65e3567?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fGRvZ3xlbnwwfDJ8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=60"
                alt="Foto de perfil"
                class="fotoPerfil rounded-circle"
                v-else
              />
...
export default {
  ...
  data() {
    return {
      ...
      //     indice: 1,
      //     img: "https://images.unsplash.com/photo-1584413544514-68a49c9b59e8?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=872&q=80",
      //     porcentaje_dias_anogestion: 98,
      //     porcentaje_dias_gestion: 66,
      //   },
      //   {
      //     concurso: "4188",
      //     ministerio: "Ministerio de Educación",
      ...
      //     indice: 2,
      //     img: "https://images.unsplash.com/photo-1584413544514-68a49c9b59e8?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=872&q=80",
      //     porcentaje_dias_anogestion: 60,
      //     porcentaje_dias_gestion: 45,
      //   },
      //   {
      //     concurso: "4143",
      //     ministerio: "Ministerio de Educación",
      ...
      //     indice: 4,
      //     img: "https://images.unsplash.com/photo-1584413544514-68a49c9b59e8?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=872&q=80",
      //     porcentaje_dias_anogestion: 0,
      //     porcentaje_dias_gestion: 0,
      //   },
      //   {
      //     concurso: "4094",
      //     ministerio: "Ministerio de Educación",
  ...
  methods: {
    ...
    filtroPorConcurso(adps) {
      return adps.filter((adp) => !adp.concurso.toString().indexOf(this.concurso));
    },
